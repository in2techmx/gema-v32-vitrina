<div class="ficha-tecnica-page">
    <div class="ficha-page-header">
        <div class="ficha-page-title">GEMA AGROECOLOGÍA<br><span style="font-size:0.75em; color:#065f46;">Proyecto Piloto San Pedro Chimay, Yucatán</span></div>
        <div class="ficha-page-subtitle">Plan de Negocios, Modelo Agroecológico &amp; Informe de Evaluación Preliminar de Inversión</div>
        <div class="ficha-page-sub2">Con Presupuesto Maestro Detallado, Desglose de Insumos y Costos Operativos Semestrales</div>
    </div>
    <div class="ficha-table-wrapper">
    ...
    <div class="ficha-footer">
        <span>IN2TECHMX Agentic Software &amp; Consulting Group — Documento Maestro</span>
        <span>Depósito Oficial MX-2026-CHIMAY-V3.2 | Edición Controlada</span>
    </div>
</div>

<div class="toc-page">
    <style>
        .toc-page { padding-top: 4mm; }
        .toc-head { border-bottom: 3px solid #059669; padding-bottom: 12px; margin-bottom: 4px; }
        .toc-title {
            font-family: 'Outfit', sans-serif; font-size: 17pt; font-weight: 800;
            color: #064e3b; letter-spacing: 0.07em; text-transform: uppercase;
            margin: 0; line-height: 1.1;
        }
        .toc-sub {
            font-size: 7.8pt; color: #64748b; margin-top: 5px;
            letter-spacing: 0.06em; text-transform: uppercase; font-weight: 600;
        }
        table.toc-table { width: 100%; border-collapse: collapse; margin: 22px 0 0 0; }
        table.toc-table tr { page-break-inside: avoid; break-inside: avoid; }
        table.toc-table td {
            padding: 15px 6px; border-bottom: 1px solid #e2e8f0;
            vertical-align: middle; background: none;
        }
        table.toc-table tr:last-child td { border-bottom: 2.5px solid #064e3b; }
        table.toc-table td.toc-num {
            width: 42px; font-family: 'Outfit', sans-serif; font-weight: 800;
            font-size: 12pt; color: #10b981; text-align: left;
        }
        table.toc-table td.toc-t { color: #0f172a; font-size: 10.2pt; font-weight: 700; line-height: 1.35; }
        table.toc-table td.toc-t span.toc-desc {
            display: block; font-size: 8pt; color: #64748b;
            font-weight: 400; margin-top: 4px; line-height: 1.45;
        }
        table.toc-table td.toc-pg {
            width: 48px; text-align: right; font-family: 'JetBrains Mono', monospace;
            font-weight: 600; font-size: 9.8pt; color: #065f46;
        }
        .toc-foot {
            margin-top: 20px; padding-top: 10px; border-top: 1px solid #e2e8f0;
            font-size: 7.4pt; color: #64748b; font-weight: 600;
    ...
    <div class="toc-head">
        ...
        <div class="toc-sub">Gema Agroecología &middot; Proyecto Piloto San Pedro Chimay, Yucatán &middot; Documento Ejecutivo Maestro</div>
    </div>
    ...
    <table class="toc-table">
        <tr>
            ...
            <td class="toc-t">Carátula, Ficha Técnica Ejecutiva &amp; Localización Georreferenciada
                <span class="toc-desc">Identificación del proyecto, misión, zonificación del polígono y estructura de gobierno</span></td>
            <td class="toc-pg">3</td>
        </tr>
        <tr>
            <td class="toc-num">02</td>
            <td class="toc-t">Resumen Ejecutivo &amp; Modelo de Negocio (Fase Piloto)
                <span class="toc-desc">Propuesta de valor, paleta vegetal, 7 canales comerciales y KPIs del piloto</span></td>
            <td class="toc-pg">6</td>
        </tr>
        <tr>
            <td class="toc-num">03</td>
            <td class="toc-t">Caracterización Edafológica, Climática e Infraestructura Hídrica
                <span class="toc-desc">Suelo Luvisol crómico (<em>Kankab</em>), régimen climático, pozo profundo y flora nativa</span></td>
        ...
        <tr>
            ...
            <td class="toc-t">Programa de Apoyos Gubernamentales e Incentivos desde la Fase Piloto
                <span class="toc-desc">Arquitectura de fondos y subsidios en los tres órdenes de gobierno</span></td>
            <td class="toc-pg">17</td>
        </tr>
        <tr>
            <td class="toc-num">05</td>
            <td class="toc-t">Marco Legal, Gobernanza Corporativa &amp; Cumplimiento Patronal IMSS
                <span class="toc-desc">Figura societaria S.P.R. de R.L., régimen AGAPES, IMSS, CONAGUA e IMPI</span></td>
        ...
        <tr>
            ...
            <td class="toc-t">Estudio de Mercado, Canales &amp; Comercialización Mérida / Riviera Maya
                <span class="toc-desc">Bodas de destino, circuito HORECA, competencia regional y matriz de precios</span></td>
        ...
        <tr>
            ...
            <td class="toc-t">Presupuesto Maestro Detallado ($169,273.00 MXN) &amp; Proyecciones Financieras
                <span class="toc-desc">Partidas A a F, catálogo de semillas y modelación a 12 meses en 3 escenarios</span></td>
            <td class="toc-pg">28</td>
        </tr>
        <tr>
            <td class="toc-num">08</td>
            <td class="toc-t">Hoja de Ruta Estratégica (Roadmap Meses 1 a 24)
                <span class="toc-desc">Fases, hitos operativos, Decision Gates y escalamiento modular</span></td>
            <td class="toc-pg">40</td>
        </tr>
        <tr>
            <td class="toc-num">09</td>
            <td class="toc-t">Matriz de Trazabilidad, Gobernanza de Compras &amp; Proveeduría
                <span class="toc-desc">Códigos WBS, niveles de autorización, proveedores homologados y almacén virtual</span></td>
            <td class="toc-pg">44</td>
        </tr>
    </table>

    <div class="toc-foot">
        <span>9 Capítulos &middot; 48 Páginas &middot; Presupuesto $169,273.00 MXN</span>
        <span>Versión V3.2 &middot; Septiembre 2026</span>
    </div>
</div>
...
<div class="kpi-row-4">
    <div class="kpi-pill">
        <div class="num">10.00 HA</div>
        <div class="lbl">Polígono Total Finca</div>
    </div>
    <div class="kpi-pill">
        <div class="num">1.00 HA</div>
        <div class="lbl">Unidad Piloto Activa</div>
    </div>
    <div class="kpi-pill">
        <div class="num">200 m²</div>
        <div class="lbl">Invernadero Tecnificado</div>
    </div>
    <div class="kpi-pill">
        <div class="num">18 Metros</div>
        <div class="lbl">Pozo Profundo N° 1</div>
    </div>
</div>

<div class="figure-grid-2">
    <div class="editorial-figure">
        <img src="../imagenes/rancho_gema_map.jpg" alt="Delimitación Satelital Rancho Gema">
        <div class="editorial-caption">
            <span>Figura 1.1: Polígono Rancho Gema (10.00 HA, San Pedro Chimay)</span>
            <span>Planimetría GIS</span>
        </div>
    </div>
    <div class="editorial-figure">
        <img src="../imagenes/san_pedro_chimay_yucatan.jpg" alt="Entorno Rural y Paisaje de San Pedro Chimay">
        <div class="editorial-caption">
            <span>Figura 1.2: Entorno Paisajístico y Microclima (San Pedro Chimay)</span>
            <span>Reserva Cuxtal</span>
        </div>
    </div>
</div>
...
<div class="flowchart-board">
    <div style="text-align: center; margin-bottom: 10px;">
        <span class="flowchart-tag green" style="font-size: 8pt; padding: 4px 12px;">MODELO MULTIDIMENSIONAL INTEGRADO — GEMA AGROECOLOGÍA (FASE PILOTO)</span>
    </div>
    <div class="visio-grid-3">
        <div class="visio-card">
            <div class="visio-card-title">Pilar 1: Fresco & Brotes Vivos</div>
            <div class="visio-card-sub">Producción Continua 365 Días</div>
            <ul>
        ...
        <div class="visio-card blue">
            <div class="visio-card-title">Pilar 2: Valor Agregado</div>
            <div class="visio-card-sub">Cero Merma & Alta Rentabilidad</div>
            <ul>
        ...
        <div class="visio-card amber">
            <div class="visio-card-title">Pilar 3: Turismo & Saberes</div>
            <div class="visio-card-sub">Biocultura & Divulgación</div>
            <ul>
    ...
    <div class="synthesis-card" style="margin: 4px 0 0 0; background: #ffffff; border: 1px solid #059669; border-left: 5px solid #047857;">
        <div class="synthesis-title" style="color: #064e3b; justify-content: space-between;">
            <span>Pilar 4: Absorción Comercial Omnicanal de Alta Gama (7 Canales Sinérgicos)</span>
            <span class="flowchart-tag green">Flujo Semanal Continuo</span>
        </div>
        <p class="synthesis-body" style="font-size: 7.2pt; color: #334155; line-height: 1.5;">
            <strong>1. HORECA Alta Gama:</strong> Restaurantes de autor y hoteles boutique en Mérida y Riviera Maya.<br>
            <strong>2. Mercados Regionales:</strong> Slow Food Mérida, Tianguis Agroecológico y ferias gourmet de fin de semana.<br>
            <strong>3. Venta por Internet:</strong> Tienda en línea oficial integrada al SaaS IN2TECHMX con pasarela SPEI/tarjetas y redes sociales.<br>
            <strong>4. Redes Comunitarias:</strong> Suscripciones directas de boca en boca para canastas familiares vía WhatsApp y Telegram.<br>
            <strong>5. Experiencias Turísticas:</strong> Boletos de agroturismo vivencial y reservas directas en finca.<br>
            <strong>6. Banquetes & Wedding Planners:</strong> Flores comestibles, brotes vivos y mixología botánica para bodas en haciendas henequeneras.<br>
...
<div class="editorial-figure">
    <img src="../imagenes/chile_habanero_yucatan.jpg" alt="Cultivo Biointensivo de Chile Habanero">
    <div class="editorial-caption">
        <span>Figura 2.1: Cultivo Biointensivo de Chile Habanero Regional (Capsicum chinense con DO Yucatán)</span>
        <span>Calidad Gourmet de Exportación</span>
    </div>
</div>
...
<div class="flowchart-board">
    <div style="text-align: center; margin-bottom: 12px;">
        <span class="flowchart-tag green" style="font-size: 8pt; padding: 4px 14px;">SECUENCIA LÓGICA ESCALONADA & HOJA DE RUTA MODULAR</span>
    </div>

    <!-- PASO 1: FASE PILOTO -->
    <div class="flowchart-step pilot">
        <div class="flowchart-step-num">PILOTO</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                <span>Fase Piloto — Laboratorio Agronómico y Comercial (1.00 HA + 200 m² Invernadero)</span>
                <span class="flowchart-tag green">6 Meses</span>
            </div>
            <p class="flowchart-step-desc">
                Descubrir cultivos y variedades óptimas para suelo Luvisol crómico (<em>Kankab</em>) y microclima de Chimay; validar rotación biointensiva, costos reales y tracción en los 7 canales comerciales.<br>
    ...
    <div class="flowchart-arrow-down amber">▼</div>

    <!-- GATE 1 -->
    <div class="flowchart-step gate">
        <div class="flowchart-step-num">GATE 1</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                <span>Decision Gate 1 — Evaluación Colegiada del Piloto & Autorización de Etapa 1</span>
                <span class="flowchart-tag amber">Hito Mes 6</span>
            </div>
            <p class="flowchart-step-desc">
    ...
    <!-- PASO 2: ETAPA 1 -->
    <div class="flowchart-step stage1">
        <div class="flowchart-step-num">ETAPA 1</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                <span>Etapa 1 — Escalamiento Técnico, Flores, Meliponario y Consolidación</span>
                <span class="flowchart-tag blue">Meses 7 a 24</span>
            </div>
            <p class="flowchart-step-desc">
    ...
    <!-- GATE 2 -->
    <div class="flowchart-step gate">
        <div class="flowchart-step-num">GATE 2</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                <span>Decision Gate 2 — Auditoría de Consolidación y Viabilidad de Expansión Mayor</span>
                <span class="flowchart-tag amber">Hito Mes 24</span>
            </div>
            <p class="flowchart-step-desc">
    ...
    <!-- PASO 3: ETAPA 2 -->
    <div class="flowchart-step stage2">
        <div class="flowchart-step-num">ETAPA 2</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                <span>Etapa 2 — Expansión Multi-Hectárea, Agroforestería y Prospección Internacional</span>
                <span class="flowchart-tag purple">Año 3+</span>
            </div>
            <p class="flowchart-step-desc">
...
<div class="editorial-figure">
    <img src="../imagenes/meliponario_chimay.jpg" alt="Santuario y Meliponario de Abeja Melipona beecheii">
    <div class="editorial-caption">
        <span>Figura 2.2: Meliponario Agroforestal Tradicional y Tecnificado (Melipona beecheii / Xunan Kab)</span>
        <span>Polinización Endémica & Miel Medicinal de Alta Gama</span>
    </div>
</div>
...
<div class="editorial-figure">
    <img src="../imagenes/organic_hero.jpg" alt="Invernadero Tecnificado y Producción de Microgreens">
    <div class="editorial-caption">
        <span>Figura 3.1: Invernadero Tecnificado de 200 m² (Microgreens & Hortalizas Baby)</span>
        <span>Producción Ininterrumpida 365 Días</span>
    </div>
</div>

<div class="synthesis-card">
    <div class="synthesis-title">Síntesis Edafológica e Hidroagrícola (Rancho Gema, Chimay)</div>
    <p class="synthesis-body">
...
<div class="flowchart-board">
    <div style="text-align: center; margin-bottom: 10px;">
        <span class="flowchart-tag green" style="font-size: 8pt; padding: 4px 14px;">ARQUITECTURA DE FONDOS & SUBSIDIOS SECTORIALES (3 NIVELES DE GOBIERNO)</span>
    </div>
    <div class="visio-grid-3">
        <div class="visio-card blue">
            <div class="visio-card-title">1. Ámbito Federal</div>
            <div class="visio-card-sub">Capital Humano & Empleo</div>
            <ul>
        ...
        <div class="visio-card">
            <div class="visio-card-title">2. Ámbito Estatal (Yucatán)</div>
            <div class="visio-card-sub">Tecnificación & Fondo Perdido</div>
            <ul>
        ...
        <div class="visio-card amber">
            <div class="visio-card-title">3. Ámbito Municipal (Mérida)</div>
            <div class="visio-card-sub">Comercialización & Entorno</div>
            <ul>
...
<div class="synthesis-card">
    <div class="synthesis-title">Impacto Financiero de los Subsidios en la Fase Piloto</div>
    <p class="synthesis-body">
...
<div class="org-chart">
    ...
    <div class="org-node-main">
        <div class="title">Comité de Dirección General (Colegiado)</div>
        <div class="subtitle">Arturo Arnaiz • Arturo de la Barrera • Gema Romero<br><strong>Decisiones Estratégicas a Discusión y Consenso</strong></div>
    </div>
    <div class="flowchart-arrow-down">▼</div>
    <div class="org-row-3">
        <div class="org-card op">
            <div class="org-card-title">Gerencia Operativa</div>
            <div class="org-card-name">Arturo de la Barrera</div>
            <ul>
        ...
        <div class="org-card biz">
            <div class="org-card-title">Dirección de Negocios</div>
            <div class="org-card-name">Arturo Arnaiz</div>
            <ul>
        ...
        <div class="org-card leg">
            <div class="org-card-title">Dirección Legal & RRPP</div>
            <div class="org-card-name">Gema Romero</div>
            <ul>
    ...
    <div class="flowchart-arrow-down">▲ &nbsp; ─── &nbsp; Enlace Operativo Local &nbsp; ─── &nbsp; ▲</div>
    <div class="org-node-bridge">
        <div class="title">Célula de Integración Financiera y Tesorería Local</div>
        <p class="desc">
            <strong>Gema Romero:</strong> Manejo de cuentas bancarias en México, pagos a proveedores mayores y dispersión formal IMSS.<br>
            <strong>Arturo de la Barrera:</strong> Custodia del fondo de caja chica en finca, dispersión física de raya semanal y compras locales.<br>
...
<div class="figure-grid-2">
    <div class="editorial-figure">
        ...
        <div class="editorial-caption">
            <span>Figura 6.1: Proveeduría Botánica en Haciendas de Mérida</span>
            <span>Bodas de Destino & HORECA</span>
        </div>
    </div>
    <div class="editorial-figure">
        <img src="../imagenes/organic_market.jpg" alt="Mercados Especializados Slow Food Mérida">
        <div class="editorial-caption">
            <span>Figura 6.2: Mercado Slow Food Mérida & Venta Directa</span>
            <span>Canal Minorista 100% Margen</span>
        </div>
    </div>
</div>
...
<div class="synthesis-card">
    <div class="synthesis-title">Sinergia Comercial de Alto Valor en San Pedro Chimay</div>
    <p class="synthesis-body">
...
<div class="kpi-row-4">
    <div class="kpi-pill">
        <div class="num">$49,273.00</div>
        <div class="lbl">CAPEX Activos Físicos</div>
    </div>
    <div class="kpi-pill">
        <div class="num">$120,000.00</div>
        <div class="lbl">OPEX 6 Meses Nómina</div>
    </div>
    <div class="kpi-pill">
        <div class="num">$169,273.00</div>
        <div class="lbl">Inversión Total Arranque</div>
    </div>
    <div class="kpi-pill">
        <div class="num">&gt; 65%</div>
        <div class="lbl">Margen Bruto Proyectado</div>
    </div>
</div>
...
<div class="flowchart-board">
    <div class="flowchart-step pilot">
        <div class="flowchart-step-num">1</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                FASE PILOTO — 1.00 HA + 200 m² Invernadero
                <span class="flowchart-tag green">Meses 1 – 6</span>
            </div>
            <div class="flowchart-step-desc">
                <ul>
    ...
    <div class="flowchart-arrow-down amber">▼</div>
    <div class="flowchart-step gate">
        <div class="flowchart-step-num"><span style="font-size:0.85rem;">G1</span></div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                DECISION GATE 1 — Comité de Dirección General
                <span class="flowchart-tag amber">Mes 6</span>
            </div>
            <div class="flowchart-step-desc">
    ...
    <div class="flowchart-arrow-down">▼</div>
    <div class="flowchart-step stage1">
        <div class="flowchart-step-num">2</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                ETAPA 1 — Escalamiento Técnico, Flores, Meliponario &amp; Consolidación
                <span class="flowchart-tag blue">Meses 7 – 24</span>
            </div>
            <div class="flowchart-step-desc">
                <ul>
    ...
    <div class="flowchart-arrow-down amber">▼</div>
    <div class="flowchart-step gate">
        <div class="flowchart-step-num"><span style="font-size:0.85rem;">G2</span></div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                DECISION GATE 2 — Auditoría Integral Etapa 1
                <span class="flowchart-tag amber">Mes 24</span>
            </div>
            <div class="flowchart-step-desc">
    ...
    <div class="flowchart-arrow-down">▼</div>
    <div class="flowchart-step stage2">
        <div class="flowchart-step-num">3</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
...
<div class="synthesis-card">
    <div class="synthesis-title">Síntesis Temporal del Roadmap a 24 Meses</div>
...
<div class="flowchart-board">
    <div class="flowchart-step pilot">
        <div class="flowchart-step-num">N1</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                Nivel 1 — Gastos Menores en Rancho
                <span class="flowchart-tag green">Hasta $5,000.00 MXN</span>
            </div>
            <div class="flowchart-step-desc">
                <strong>Ejecutor:</strong> Arturo de la Barrera (Gerente Operativo)<br>
                <strong>Instrumento:</strong> Fondo Revolvente de Caja Chica ($10,000.00 MXN en efectivo)<br>
                <strong>Conceptos:</strong> Combustibles, refacciones urgentes de riego, consumibles locales, jornales eventuales<br>
    ...
    <div class="flowchart-arrow-down">▼</div>
    <div class="flowchart-step stage1">
        <div class="flowchart-step-num">N2</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                Nivel 2 — Compras Operativas &amp; Reabastecimiento
                <span class="flowchart-tag blue">$5,001.00 – $25,000.00 MXN</span>
            </div>
            <div class="flowchart-step-desc">
                <strong>Ejecutores:</strong> Visto Bueno mancomunado Arturo de la Barrera + Gema Romero<br>
                <strong>Instrumento:</strong> Transferencia electrónica bancaria desde la cuenta en México<br>
                <strong>Conceptos:</strong> Lotes de semillas, rollos de malla sombra, tambos de bioinsumos, empaques<br>
    ...
    <div class="flowchart-arrow-down">▼</div>
    <div class="flowchart-step stage2">
        <div class="flowchart-step-num">N3</div>
        <div class="flowchart-step-body">
            <div class="flowchart-step-title">
                Nivel 3 — Inversiones Estratégicas &amp; Contratos Mayores
                <span class="flowchart-tag purple">&gt; $25,000.00 MXN</span>
            </div>
            <div class="flowchart-step-desc">
                <strong>Ejecutor:</strong> Comité de Dirección General — consenso unánime de los 3 socios<br>
                <strong>Instrumento:</strong> Transferencia bancaria institucional con doble factor de autenticación<br>
                <strong>Conceptos:</strong> Perforaciones adicionales, electrificación, tecnificación Etapa 1, vehículos<br>
...
<div class="synthesis-card">
    <div class="synthesis-title">Dictamen de Viabilidad — IN2TECHMX (Versión V3.2)</div>
    <div class="synthesis-body">
...
<div class="signatures-certificate">
    <div class="signatures-header">
        <div class="signatures-title">RATIFICACIÓN Y FIRMAS DE GOBERNANZA</div>
        <div class="signatures-subtitle">Gema Agroecología (Nombre Preliminar) · Documento Ejecutivo Maestro — Versión V3.2 · Septiembre 2026</div>
        <div class="signatures-subtitle" style="font-weight:600; margin-top:6px;">Por el Comité de Dirección General &amp; Asamblea Fundadora</div>
    </div>
    <div class="signatures-grid">
        <div class="sig-block">
            <div class="sig-line"></div>
            <div class="sig-name">Arturo Arnaiz</div>
            <div class="sig-role">Dirección de Negocios</div>
            <div class="sig-desc">Estrategia Comercial B2B, SaaS &amp; Macro-Finanzas · Supervisión Financiera</div>
        </div>
        <div class="sig-block">
            <div class="sig-line"></div>
            <div class="sig-name">Arturo de la Barrera</div>
            <div class="sig-role">Gerencia Operativa</div>
            <div class="sig-desc">Gestión Agronómica, Invernadero, Inocuidad &amp; Talleres de Campo</div>
        </div>
        <div class="sig-block">
            <div class="sig-line"></div>
            <div class="sig-name">Gema Romero</div>
            <div class="sig-role">Dirección Legal &amp; Relaciones Públicas</div>
            <div class="sig-desc">Estructura Societaria, Subsidios STPS/SEDER, Bancos &amp; Tesorería Operativa Local</div>
        </div>
        <div class="sig-block">
            <div class="sig-line"></div>
            <div class="sig-name">Metodología IN2TECHMX</div>
            <div class="sig-role">Especialista en Auditoría y Aseguramiento de Calidad</div>
            <div class="sig-desc">Certificación de Rigor Metodológico, Trazabilidad WBS &amp; Versión V3.2</div>
        </div>
    </div>
</div>
